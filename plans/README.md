...
| 038  | ペットに「うちに来た日」を持たせ、何日めかを札に出す                                            | P2       | S      | —          | TODO                                                                             |
| 039  | 音が止まっているあいだの足音や物音を溜めない                                                    | P3       | S      | —          | TODO                                                                             |
| 040  | ひらめきナゾを好きな順に解けるようにし、解いたナゾを 1 問ずつ覚える                             | P1       | M      | —          | TODO                                                                             |
| 041  | 場面に入るとき、シェーダーの準備が済むまで描かずに待つ                                          | P3       | S      | —          | TODO                                                                             |
| 042  | 初めて組み立てるペットを 1 フレームに 1 匹ずつにし、長く固まらないようにする                    | P2       | M      | 041        | TODO                                                                             |
